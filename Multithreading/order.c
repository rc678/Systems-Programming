...
/*struct for the hashtable which contains the threads and categories*/
struct my_struct{
	const char* category;
	QueuePtr q;
	UT_hash_handle hh; 
...
void* producer(void* file)
{
	...
	/*goes through the orders.txt line and stores order in the proper queue*/
...
/*process information in each category queue*/
